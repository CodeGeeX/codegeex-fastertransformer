...
template<typename T>
void ParallelCodegeexDecoderLayerWeight<T>::compress_weights(cublasMMWrapper& cublas_wrapper, int hidden_dim)
{
...
template<typename T>
void ParallelCodegeexDecoderLayerWeight<T>::transposeCalibrateQuantizeWeight()
{
