...
template<typename T>
struct ParallelCodegeexDecoderLayerWeight {
public:
    ParallelCodegeexDecoderLayerWeight() = default;
    ParallelCodegeexDecoderLayerWeight(const int int8_mode);
    ParallelCodegeexDecoderLayerWeight(const int hidden_units,
                                  const int inter_size,
                                  const int tensor_para_size,
                                  const int tensor_para_rank,
                                  const int int8_mode = 0);
    ~ParallelCodegeexDecoderLayerWeight();
    ParallelCodegeexDecoderLayerWeight(const ParallelCodegeexDecoderLayerWeight& other);
    ParallelCodegeexDecoderLayerWeight& operator=(const ParallelCodegeexDecoderLayerWeight& other);
