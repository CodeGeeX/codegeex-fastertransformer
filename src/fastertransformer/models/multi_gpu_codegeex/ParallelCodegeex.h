...
template<typename T>
class ParallelCodegeex: public BaseLayer {
private:
    // meta data
    size_t head_num_;
    ...
    ParallelCodegeexDecoder<T>* codegeex_decoder_;
    ParallelCodegeexContextDecoder<T>* codegeex_context_decoder_;
...
protected:
    ...
    T* context_decoder_input_top_buf_;
...
public:
    ParallelCodegeex(size_t max_batch_size,
                size_t max_seq_len,
                size_t max_input_len,
                size_t beam_width,
                size_t head_num,
    ...
    ParallelCodegeex(ParallelCodegeex<T> const& codegeex);
