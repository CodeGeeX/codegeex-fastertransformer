...
template<typename T>
struct ParallelCodegeexTopQueryLayerWeight {
public:
    ParallelCodegeexTopQueryLayerWeight() = default;
    ParallelCodegeexTopQueryLayerWeight(const int int8_mode);
    ParallelCodegeexTopQueryLayerWeight(const int hidden_units,
                                  const int inter_size,
                                  const int tensor_para_size,
                                  const int tensor_para_rank,
                                  const int int8_mode = 0);
    ~ParallelCodegeexTopQueryLayerWeight();
