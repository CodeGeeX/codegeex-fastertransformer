...
template<typename T>
CodegeexDecoderLayerWeight<T>::CodegeexDecoderLayerWeight(const int hidden_units, const int inter_size):
...
template<typename T>
CodegeexDecoderLayerWeight<T>::~CodegeexDecoderLayerWeight()
{
...
template<typename T>
CodegeexDecoderLayerWeight<T>::CodegeexDecoderLayerWeight(const CodegeexDecoderLayerWeight& other):
...
template<typename T>
CodegeexDecoderLayerWeight<T>& CodegeexDecoderLayerWeight<T>::operator=(const CodegeexDecoderLayerWeight& other)
{
...
template<typename T>
void CodegeexDecoderLayerWeight<T>::loadModel(std::string dir_path)
{
...
template<typename T>
void CodegeexDecoderLayerWeight<T>::setWeightPtr()
{
...
template<typename T>
void CodegeexDecoderLayerWeight<T>::mallocWeights()
{
...
template<typename T>
void CodegeexDecoderLayerWeight<T>::compress_weights(cublasMMWrapper& cublas_wrapper, int hidden_dim)
{
...
template struct CodegeexDecoderLayerWeight<float>;
template struct CodegeexDecoderLayerWeight<half>;
