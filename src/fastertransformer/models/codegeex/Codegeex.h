...
template<typename T>
class Codegeex: public BaseLayer {
private:
    // buffer handling
    ...
    CodegeexDecoder<T>* codegeex_decoder_;
    DynamicDecodeBaseLayer* dynamic_decode_;
    CodegeexContextDecoder<T>* codegeex_context_decoder_;
...
public:
    Codegeex(size_t max_batch_size,
        size_t max_seq_len,
    ...
    Codegeex(Codegeex<T> const& Codegeex);
