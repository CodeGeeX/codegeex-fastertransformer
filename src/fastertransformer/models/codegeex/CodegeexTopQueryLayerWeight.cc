...
#include "src/fastertransformer/models/codegeex/CodegeexTopQueryLayerWeight.h"
#include "src/fastertransformer/utils/memory_utils.h"

namespace fastertransformer {

template<typename T>
CodegeexTopQueryLayerWeight<T>::CodegeexTopQueryLayerWeight(const int hidden_units, const int inter_size):
...
template<typename T>
CodegeexTopQueryLayerWeight<T>::~CodegeexTopQueryLayerWeight()
{
...
template<typename T>
CodegeexTopQueryLayerWeight<T>::CodegeexTopQueryLayerWeight(const CodegeexTopQueryLayerWeight& other):
    hidden_units_(other.hidden_units_), inter_size_(other.inter_size_)
{
    ...
    cudaD2Dcpy(weights_ptr[2], other.weights_ptr[2], hidden_units_ * 1 * hidden_units_);
    cudaD2Dcpy(weights_ptr[3], other.weights_ptr[3], 1 * hidden_units_);
    cudaD2Dcpy(weights_ptr[4], other.weights_ptr[4], hidden_units_ * 2 * hidden_units_);
    cudaD2Dcpy(weights_ptr[5], other.weights_ptr[5], 2 * hidden_units_);
...
template<typename T>
CodegeexTopQueryLayerWeight<T>& CodegeexTopQueryLayerWeight<T>::operator=(const CodegeexTopQueryLayerWeight& other)
{
...
template<typename T>
void CodegeexTopQueryLayerWeight<T>::loadModel(std::string dir_path)
{
    ...
    loadWeightFromBin<T>(
        weights_ptr[2], {hidden_units_, 1 * hidden_units_}, dir_path + ".attention.query.weight.0.bin");
    loadWeightFromBin<T>(weights_ptr[3], {1, hidden_units_}, dir_path + ".attention.query.bias.0.bin");
    loadWeightFromBin<T>(
        weights_ptr[4], {hidden_units_, 2 * hidden_units_}, dir_path + ".attention.key_value.weight.0.bin");
    loadWeightFromBin<T>(weights_ptr[5], {2, hidden_units_}, dir_path + ".attention.key_value.bias.0.bin");
    loadWeightFromBin<T>(weights_ptr[6], {hidden_units_, hidden_units_}, dir_path + ".attention.dense.weight.0.bin");
    loadWeightFromBin<T>(weights_ptr[7], {hidden_units_}, dir_path + ".attention.dense.bias.bin");
    loadWeightFromBin<T>(weights_ptr[8], {hidden_units_}, dir_path + ".post_attention_layernorm.bias.bin");
    loadWeightFromBin<T>(weights_ptr[9], {hidden_units_}, dir_path + ".post_attention_layernorm.weight.bin");

    loadWeightFromBin<T>(
        weights_ptr[10], {hidden_units_, 4 * hidden_units_}, dir_path + ".mlp.dense_h_to_4h.weight.0.bin");
    loadWeightFromBin<T>(weights_ptr[11], {4 * hidden_units_}, dir_path + ".mlp.dense_h_to_4h.bias.0.bin");
    loadWeightFromBin<T>(
        weights_ptr[12], {4 * hidden_units_, hidden_units_}, dir_path + ".mlp.dense_4h_to_h.weight.0.bin");
    loadWeightFromBin<T>(weights_ptr[13], {hidden_units_}, dir_path + ".mlp.dense_4h_to_h.bias.bin");
}

template<typename T>
void CodegeexTopQueryLayerWeight<T>::setWeightPtr()
{
...
template<typename T>
void CodegeexTopQueryLayerWeight<T>::mallocWeights()
{
    deviceMalloc(&weights_ptr[0], hidden_units_);
    deviceMalloc(&weights_ptr[1], hidden_units_);
    deviceMalloc(&weights_ptr[2], hidden_units_ * 1 * hidden_units_);
    deviceMalloc(&weights_ptr[3], 1 * hidden_units_);
    deviceMalloc(&weights_ptr[4], hidden_units_ * 2 * hidden_units_);
    deviceMalloc(&weights_ptr[5], 2 * hidden_units_);
...
template<typename T>
void CodegeexTopQueryLayerWeight<T>::compress_weights(cublasMMWrapper& cublas_wrapper, int hidden_dim)
{
    ...
    int shapes[num_sparse_weights][2] = {
        {hidden_units_, 1 * hidden_units_},
        {hidden_units_, 2 * hidden_units_},
    ...
    self_attention_weights.value_weight.sp_kernel = sp_weights_ptr[1];
...
template struct CodegeexTopQueryLayerWeight<float>;
template struct CodegeexTopQueryLayerWeight<half>;
