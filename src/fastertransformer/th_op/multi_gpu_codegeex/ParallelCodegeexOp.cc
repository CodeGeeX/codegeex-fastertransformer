...
#include "src/fastertransformer/th_op/multi_gpu_codegeex/ParallelCodegeexOp.h"
#include "src/fastertransformer/th_op/multi_gpu_codegeex/WeightTransposeCalibrateQuantizeOp.h"

namespace th = torch;
namespace torch_ext {

ParallelCodegeexOp::ParallelCodegeexOp(const int64_t head_num,
...
ParallelCodegeexOp::~ParallelCodegeexOp()
{
    delete ftcodegeex;
}

std::vector<th::Tensor> ParallelCodegeexOp::forward(th::Tensor input_ids,
...
static auto fasterTransformerCodegeexTHS = torch::jit::class_<torch_ext::ParallelCodegeexOp>("FasterTransformer", "ParallelCodegeexOp")
                                          .def(torch::jit::init<int64_t,
                                                                ...
                                                                std::vector<th::Tensor>,
                                                                std::vector<th::Tensor>>())
                                          .def("forward", &torch_ext::ParallelCodegeexOp::forward);
