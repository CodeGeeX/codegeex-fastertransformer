        ...
        for (int i = 0; i < (int)layer_num_-1; i++) {
            ...
            if (int8_mode_ != 0) {
                codegeex_weights_.decoder_layer_weights[i]->self_attention_weights.query_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[i + 0 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->self_attention_weights.query_weight.scale =
                    get_ptr<float>(scale_[i + 0 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->self_attention_weights.attention_output_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[i + 1 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->self_attention_weights.attention_output_weight.scale =
                    get_ptr<float>(scale_[i + 1 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->ffn_weights.intermediate_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[i + 2 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->ffn_weights.intermediate_weight.scale =
                    get_ptr<float>(scale_[i + 2 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->ffn_weights.output_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[i + 3 * (layer_num_-1)]);
                codegeex_weights_.decoder_layer_weights[i]->ffn_weights.output_weight.scale =
                    get_ptr<float>(scale_[i + 3 * (layer_num_-1)]);
            }
        }
        ...
        for (int i = 0; i < 1; i++) {
            ...
            if (int8_mode_ != 0) {
                codegeex_weights_.topquery_layer_weights[i]->self_attention_weights.query_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[4 * (layer_num_-1) + i + 0 ]);
                codegeex_weights_.topquery_layer_weights[i]->self_attention_weights.query_weight.scale =
                    get_ptr<float>(scale_[4 * (layer_num_-1) + i + 0 ]);
                codegeex_weights_.topquery_layer_weights[i]->self_attention_weights.key_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[4 * (layer_num_-1) + i + 1 ]);
                codegeex_weights_.topquery_layer_weights[i]->self_attention_weights.key_weight.scale =
                    get_ptr<float>(scale_[4 * (layer_num_-1) + i + 1 ]);
                codegeex_weights_.topquery_layer_weights[i]->self_attention_weights.attention_output_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[4 * (layer_num_-1) + i + 2 ]);
                codegeex_weights_.topquery_layer_weights[i]->self_attention_weights.attention_output_weight.scale =
                    get_ptr<float>(scale_[4 * (layer_num_-1) + i + 2 ]);
                codegeex_weights_.topquery_layer_weights[i]->ffn_weights.intermediate_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[4 * (layer_num_-1) + i + 3 ]);
                codegeex_weights_.topquery_layer_weights[i]->ffn_weights.intermediate_weight.scale =
                    get_ptr<float>(scale_[4 * (layer_num_-1) + i + 3 ]);
                codegeex_weights_.topquery_layer_weights[i]->ffn_weights.output_weight.int8_kernel =
                    get_ptr<int8_t>(int8_weights_[4 * (layer_num_-1) + i + 4 ]);
                codegeex_weights_.topquery_layer_weights[i]->ffn_weights.output_weight.scale =
                    get_ptr<float>(scale_[4 * (layer_num_-1) + i + 4 ]);
            }
        }
...
class ParallelCodegeexOp: public th::jit::CustomClassHolder {
public:
    ParallelCodegeexOp(const int64_t head_num,
