...
//top query embedding lookup
template<typename T>
__global__ void start_id_position_lookups_kernel(T* from_tensor,
                                                           int* output_ids,
                                                           const T* pos_table,
                                                           const int* input_ids,
                                                           const int start_step,
...
template<typename T>
void invokeInputIdsLookupTopPosEncoding(T* from_tensor,
                                              int* output_ids,
                                              const T* pos_table,
                                              const int* input_ids,
                                              const int start_step,
                                              ...
                                              cudaStream_t stream)
{
    ...
    dim3 block(min(hidden_units, 512));
    if (output_ids == nullptr) {
        start_id_position_lookups_kernel<T><<<grid, block, 0, stream>>>(from_tensor,
                                                                                  pos_table,
                                                                                  input_ids,
                                                                                  start_step,
                                                                                  length,
...
template void invokeInputIdsLookupTopPosEncoding(float* from_tensor,
                                                       int* output_ids,
                                                       const float* pos_table,
                                                       const int* input_ids,
                                                       const int start_step,
...
template void invokeInputIdsLookupTopPosEncoding(half* from_tensor,
                                                       int* output_ids,
                                                       const half* pos_table,
                                                       const int* input_ids,
                                                       const int start_step,
...
#ifdef ENABLE_BF16
template void invokeInputIdsLookupTopPosEncoding(__nv_bfloat16* from_tensor,
                                                       int* output_ids,
                                                       const __nv_bfloat16* pos_table,
                                                       const int* input_ids,
                                                       const int start_step,
...
__global__ void tileCodegeexInputs(int* tiled_input_ids,
...
void invokeTileCodegeexInputs(int* tiled_input_ids,
                         int* tiled_input_lengths,
                         const int* input_ids,
                         const int* input_lengths,
                         const int batch_size,
                         ...
                         cudaStream_t stream)
{
    ...
    tileCodegeexInputs<<<grid, block, 0, stream>>>(
