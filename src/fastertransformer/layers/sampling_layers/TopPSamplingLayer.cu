...
void TopPSamplingLayer<T>::freeBuffer()
{
    ...
    if (is_allocate_buffer_) {
        ...
        allocator_->free(runtime_top_k_buf_);
        allocator_->free(runtime_top_p_buf_);
        allocator_->free(initial_top_p_buf_);
        allocator_->free(top_p_decay_buf_);
        allocator_->free(top_p_min_buf_);
        allocator_->free(top_p_reset_ids_buf_);
    }
