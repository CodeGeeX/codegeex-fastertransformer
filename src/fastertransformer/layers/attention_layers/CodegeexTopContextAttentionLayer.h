...
template<typename T>
class CodegeexTopContextAttentionLayer: public BaseAttentionLayer<T> {
private:
    // buffer handling
...
public:
    ...
    CodegeexTopContextAttentionLayer(CodegeexTopContextAttentionLayer<T> const& attention_layer);

    virtual ~CodegeexTopContextAttentionLayer();
