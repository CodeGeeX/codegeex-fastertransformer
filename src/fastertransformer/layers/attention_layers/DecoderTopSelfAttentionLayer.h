...
template<typename T>
class DecoderTopSelfAttentionLayer: public BaseAttentionLayer<T> {
private:
    // buffer handling
...
public:
    DecoderTopSelfAttentionLayer(size_t max_batch_size,
                              size_t head_num,
    ...
    DecoderTopSelfAttentionLayer(DecoderTopSelfAttentionLayer<T> const& attention_layer);

    ~DecoderTopSelfAttentionLayer();
...
void fusedQKV_masked_attention_dispatch(const T* q_buf,
		                        const T* kv_buf,
                                        ...
                                        cudaStream_t stream)
{
    fusedQKV_masked_attention_dispatch(q_buf,
		                       kv_buf,
                                       q_bias,
                                       kv_bias,
                                       key_cache,
